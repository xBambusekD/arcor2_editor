...
namespace Hololens {
    ...
    public class ParameterMetadataH :  IO.Swagger.Model.ParameterMeta
    {
        public const string INT = "integer";
            ...
            public ParameterMetadataH(IO.Swagger.Model.ParameterMeta actionParameterMeta): base(defaultValue: actionParameterMeta.DefaultValue, description: actionParameterMeta.Description, dynamicValue: actionParameterMeta.DynamicValue,
            ...
            public async Task<List<string>> LoadDynamicValues(string actionProviderId, List<IO.Swagger.Model.IdValue> parentParams) {
                ...
                return await WebSocketManagerH.Instance.GetActionParamValues(actionProviderId, Name, parentParams);
            }
