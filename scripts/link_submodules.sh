...
rm -r ../arcor2_AREditor/Submodules/QRTracking/SampleQRCodes/Assets/MRTK
rm -r ../arcor2_AREditor/Submodules/QRTracking/SampleQRCodes/Assets/MixedRealityToolkit.Generated
